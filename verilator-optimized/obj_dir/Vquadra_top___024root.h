...
class alignas(VL_CACHE_LINE_BYTES) Vquadra_top___024root final : public VerilatedModule {
  public:
    ...
    SData/*14:0*/ quadra_top__DOT__my_quadra__DOT__c;
    VL_IN(x,23,0);
    VL_OUT(y,24,0);
    IData/*28:0*/ quadra_top__DOT__my_quadra__DOT__s;
    IData/*24:0*/ quadra_top__DOT__my_quadra__DOT__a;
    ...
    VlWide<4>/*99:0*/ quadra_top__DOT__my_quadra__DOT__stage2;
    VlWide<3>/*87:0*/ quadra_top__DOT__my_quadra__DOT__stage3;
